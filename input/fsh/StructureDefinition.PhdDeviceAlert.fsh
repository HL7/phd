...
// Alert Type
// ------------------------------------------------------------
* code from http://terminology.hl7.org/ValueSet/devicealert-condition|2.0.0 (required) // for 6.0.0-ballot4 or later; moved from hl7.org/fhir to terminology.hl7.org in ballot5
