...
// Alert Type
// ------------------------------------------------------------
* condition.code from http://hl7.org/fhir/ValueSet/devicealert-condition|6.0.0-ballot3 (required)
//* code from http://hl7.org/fhir/ValueSet/devicealert-condition|6.0.0-ballot4 (required)
