...
|Simple Alerting|Only with Quantities|complex extension| Gives the parameters for a`lerting and thresholding on a quantity.|
...
An example of the Time Tick resolution property entry is given below.
